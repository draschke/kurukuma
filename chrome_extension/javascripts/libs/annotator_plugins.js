...
Annotator = (function(_super) {
  ...
  Annotator.prototype.showEditor = function(annotation, location) {
    ...
    if (this.plugins.Twitter && typeof annotation.text === 'undefined') {
      annotation.text = this.plugins.Twitter.initTextFormat(this.selectedText);
    }
  ...
  Annotator.prototype.getSelectedText = function() {
    var normed, normedRanges, r, root, selectedRanges, _k, _l, _len2, _len3;
    root = this.wrapper[0];
...
Annotator.Plugin.Twitter = (function(_super) {
  ...
  Twitter.prototype.field = null;

  Twitter.prototype.input = null;

  Twitter.prototype.user_info = null;

  Twitter.prototype.options = {
    image_size: 36
  };
  ...
  Twitter.prototype.pluginInit = function() {
    ...
    */
    ...
    return $(this.annotator.editor.fields[0].element).bind({
      "keyup": function(e) {
        var count;
        count = e.target.value.length;
        return $(_this.field).find(".annotator-twitter-counter").text(count);
      }
    });
  };

  Twitter.prototype.updateViewer = function(field, annotation) {
    field = $(field);
    if (annotation.twitter) {
      return field.addClass('annotator-twitter').html(this.getHtml(annotation.twitter));
    } else {
      return field.remove();
    }
  };
  ...
  Twitter.prototype.getHtml = function(ui, editor_flg) {
    var size, string;
    if (editor_flg == null) {
      editor_flg = false;
    }
  ...
  Twitter.prototype.initTextFormat = function(text) {
    text = '"' + text + '" - ';
    text = text.replace(/\n/g, "");
    return text;
  };
